...
class App extends Component {
  render() {
    ...
    <Layout>
        ...
        <Drawer style={{backgroundColor:'lightblue'}} title={<Link style={{textDecoration:'none', color:'black'}}to="/">MyPortfolio</Link>} >
        <Navigation>
            
                <Link style={{textDecoration:'none', color:'black'}} to="/resume">Resume</Link>
                <Link style={{textDecoration:'none', color:'black'}} to="/aboutme">AboutMe</Link>
